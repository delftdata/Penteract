...
class StorageAdapter {
 public:
  ...
  virtual std::size_t getKeyCount() const = 0;
};
...
class KVStorageAdapter : public StorageAdapter {
 public:
  ...
  std::size_t getKeyCount() const final { return storage_->getKeyCount(); } 
...
class TxnStorageAdapter : public StorageAdapter {
 public:
  ...
  std::size_t getKeyCount() const final { return key_index_.size(); } 
