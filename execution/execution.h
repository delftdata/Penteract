...
class BenchXExecution : public Execution {
 public:
  BenchXExecution(const SharderPtr& sharder, const std::shared_ptr<Storage>& storage);
  void Execute(Transaction& txn) final;
...
class MovieExecution : public Execution {
 public:
  MovieExecution(const SharderPtr& sharder, const std::shared_ptr<Storage>& storage);
  void Execute(Transaction& txn) final;
...
class PPSExecution : public Execution {
 public:
  PPSExecution(const SharderPtr& sharder, const std::shared_ptr<Storage>& storage);
  void Execute(Transaction& txn) final;
...
class SmallBankExecution : public Execution {
 public:
  SmallBankExecution(const SharderPtr& sharder, const std::shared_ptr<Storage>& storage);
  void Execute(Transaction& txn) final;
