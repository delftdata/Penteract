...
BenchXMetadataInitializer::BenchXMetadataInitializer(uint32_t num_regions, uint32_t num_partitions)
    : num_regions_(num_regions), num_partitions_(num_partitions) {}

Metadata BenchXMetadataInitializer::Compute(const Key& key) {
