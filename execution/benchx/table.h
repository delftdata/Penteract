...
#include "execution/benchx/scalar.h"
#include "execution/benchx/storage_adapter.h"

namespace slog {
namespace benchx {

enum TableId : int8_t { WAREHOUSE, DISTRICT, CUSTOMER, CUSTOMER_BY_NAME, HISTORY, NEW_ORDER, ORDER, ORDER_LINE, ITEM, ITEM_BY_NAME, STOCK };
...
SCHEMA(CustomerByNameSchema,
       TableId::CUSTOMER_BY_NAME,
       4, // NUM_COLUMNS
       3,  // PKEY_SIZE
       false, // GROUPED
       ARRAY(W_ID,
...
SCHEMA(ItemByNameSchema,
       TableId::ITEM_BY_NAME,
       3, // NUM_COLUMNS
       2, // PKEY_SIZE
       false, // GROUPED
       ARRAY(W_ID,
